    ...
    <div className="pt-16">
      ...
      <section className="bg-gradient-to-br from-bg-cream to-bg-light min-h-[70vh] flex items-center justify-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center w-full">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-header mb-4 md:mb-6">
          ...
          <Link
            to="/request"
            className="inline-flex items-center bg-emergency text-white px-6 md:px-8 py-3 md:py-4 rounded-xl text-base md:text-lg font-semibold hover:bg-opacity-90 transition-all transform hover:scale-105 shadow-lg"
          >
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center text-header mb-8 md:mb-16">
            How LifeLane Works
          </h2>
          <div className="grid md:grid-cols-3 gap-8 md:gap-12">
            <div className="text-center">
              <div className="bg-emergency bg-opacity-10 p-4 md:p-6 rounded-full w-16 h-16 md:w-24 md:h-24 mx-auto mb-4 md:mb-6 flex items-center justify-center">
                <AlertCircle className="w-8 h-8 md:w-12 md:h-12 text-emergency" />
              </div>
              <h3 className="text-xl md:text-2xl font-semibold text-header mb-2 md:mb-4">1. Request</h3>
            ...
            <div className="text-center">
              <div className="bg-success bg-opacity-10 p-4 md:p-6 rounded-full w-16 h-16 md:w-24 md:h-24 mx-auto mb-4 md:mb-6 flex items-center justify-center">
                <CheckCircle className="w-8 h-8 md:w-12 md:h-12 text-success" />
              </div>
              <h3 className="text-xl md:text-2xl font-semibold text-header mb-2 md:mb-4">2. Approval</h3>
              <p className="text-sm md:text-base text-gray-600 leading-relaxed">
            ...
            <div className="text-center">
              <div className="bg-primary bg-opacity-10 p-4 md:p-6 rounded-full w-16 h-16 md:w-24 md:h-24 mx-auto mb-4 md:mb-6 flex items-center justify-center">
                <Zap className="w-8 h-8 md:w-12 md:h-12 text-primary" />
              </div>
              <h3 className="text-xl md:text-2xl font-semibold text-header mb-2 md:mb-4">3. Activation</h3>
              <p className="text-sm md:text-base text-gray-600 leading-relaxed">
      ...
      <section className="w-full bg-gradient-to-br from-[#fffcf5] to-[#f4f5f7] py-16 md:py-24 px-4">
        <div className="max-w-5xl mx-auto flex flex-col items-center">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#1c3356] text-center mb-4">How LifeLane Can Save Millions of Lives</h2>
          <p className="text-base sm:text-lg text-[#1c3356]/80 text-center max-w-[700px] mb-8 md:mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 w-full mb-8 md:mb-10">
            {/* Feature 1 */}
            <div className="bg-white rounded-2xl shadow-md hover:shadow-xl transition-shadow p-4 md:p-6 flex flex-col items-center text-center group">
              <span className="text-2xl md:text-3xl mb-3 md:mb-4 transition-transform group-hover:scale-110">🚗</span>
              <div className="font-semibold text-[#1c3356] mb-2 text-base md:text-lg lg:text-xl">Turns any private car into an emergency-ready vehicle</div>
            </div>
            {/* Feature 2 */}
            <div className="bg-white rounded-2xl shadow-md hover:shadow-xl transition-shadow p-4 md:p-6 flex flex-col items-center text-center group">
              <span className="text-2xl md:text-3xl mb-3 md:mb-4 transition-transform group-hover:scale-110">⚙️</span>
              <div className="font-semibold text-[#1c3356] mb-2 text-base md:text-lg lg:text-xl">Verified instantly by LifeLane admin team</div>
            </div>
            {/* Feature 3 */}
            <div className="bg-white rounded-2xl shadow-md hover:shadow-xl transition-shadow p-4 md:p-6 flex flex-col items-center text-center group">
              <span className="text-2xl md:text-3xl mb-3 md:mb-4 transition-transform group-hover:scale-110">🔐</span>
              <div className="font-semibold text-[#1c3356] mb-2 text-base md:text-lg lg:text-xl">Activates secure, one-time-use siren codes</div>
            </div>
            {/* Feature 4 */}
            <div className="bg-white rounded-2xl shadow-md hover:shadow-xl transition-shadow p-4 md:p-6 flex flex-col items-center text-center group">
              <span className="text-2xl md:text-3xl mb-3 md:mb-4 transition-transform group-hover:scale-110">⏱️</span>
              <div className="font-semibold text-[#1c3356] mb-2 text-base md:text-lg lg:text-xl">Cuts down delays in emergency response</div>
            </div>
            {/* Feature 5 */}
            <div className="bg-white rounded-2xl shadow-md hover:shadow-xl transition-shadow p-4 md:p-6 flex flex-col items-center text-center group">
              <span className="text-2xl md:text-3xl mb-3 md:mb-4 transition-transform group-hover:scale-110">📲</span>
              <div className="font-semibold text-[#1c3356] mb-2 text-base md:text-lg lg:text-xl">100% digital — no paperwork</div>
            </div>
            {/* Feature 6 */}
            <div className="bg-white rounded-2xl shadow-md hover:shadow-xl transition-shadow p-4 md:p-6 flex flex-col items-center text-center group">
              <span className="text-2xl md:text-3xl mb-3 md:mb-4 transition-transform group-hover:scale-110">🌍</span>
              <div className="font-semibold text-[#1c3356] mb-2 text-base md:text-lg lg:text-xl">Easy and accessible for everyone</div>
            </div>
          </div>
